...
public class Serial implements Runnable, MessageListener {
	...
	System.out.println("Created socket on port 3800");
    ...
    public void messageReceived(int dest_addr, Message message) {
        ...
        if (message instanceof BN_CollMsg)
        {
            ...
            System.out.println(CollectedMsg.get_moteid());
            System.out.println(convertTemperature(CollectedMsg.get_tempreading()));
            System.out.println(convertHumidity(CollectedMsg.get_humidityreading()));
            System.out.println(convertLight(CollectedMsg.get_lightreading()));
            System.out.println(convertButton(CollectedMsg.get_button()));
