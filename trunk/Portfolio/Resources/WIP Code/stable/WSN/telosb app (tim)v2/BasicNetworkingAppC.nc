...
implementation {
 ...
 components MainC;
  ...
  BasicNetworkingC.CollectReceiveC->Collector.Receive[AM_COLLMSG];
  BasicNetworkingC.CollectReceiveL->Collector.Receive[AM_LOCMSG];
  BasicNetworkingC.CollectReceiveS->Collector.Receive[AM_STATMSG];
