...
enum {
  ...
  DEFAULT_SAMPLING_PERIOD = 100000,		// period for sampling the sensors of the node
...
typedef nx_struct LocMsg { 
  ...
  nx_uint8_t VANs;					// Grade of anchor of the source (0= BN, 1=3AN...)
  nx_uint8_t VANr;					// Grade of anchor of the receiver (0= BN, 1=3AN...)  
