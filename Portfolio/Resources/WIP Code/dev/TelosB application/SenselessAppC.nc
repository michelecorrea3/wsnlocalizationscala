...
implementation {
  ...
  // Calibration
  //---------------------------------------------------------------------------
  components new AMReceiverC(0x95) as CalibrationReceiver;
  components new AMSenderC(0x95) as CalibrationSender;
  
  SenselessC.CalibrationReceive->CalibrationReceiver;
  SenselessC.CalibrationSend -> CalibrationSender;
