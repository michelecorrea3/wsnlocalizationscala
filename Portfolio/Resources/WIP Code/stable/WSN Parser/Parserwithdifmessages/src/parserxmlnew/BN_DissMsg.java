 ...
 * This class implements a Java interface to the 'BN_DissMsg'
 * message type.
 */

package parserxmlnew;

public class BN_DissMsg extends net.tinyos.message.Message {
    ...
    /** Create a new BN_DissMsg of size 5. */
    public BN_DissMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new BN_DissMsg of the given data_length. */
    public BN_DissMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BN_DissMsg with the given data_length
     * and base offset.
     */
    public BN_DissMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BN_DissMsg using the given byte array
     * as backing store.
     */
    public BN_DissMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public BN_DissMsg(byte[] data, int base_offset) {
     ...
     */
    public BN_DissMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BN_DissMsg embedded in the given message
     * at the given base offset.
     */
    public BN_DissMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public BN_DissMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
