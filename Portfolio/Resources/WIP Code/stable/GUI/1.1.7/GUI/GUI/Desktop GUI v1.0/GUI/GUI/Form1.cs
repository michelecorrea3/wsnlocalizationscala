...
namespace GUI
{
    public partial class Form1 : Form
    {
        ...
        private void GetGraphData()
        {
                ...
                try
                {
                    if (comboBox2.SelectedItem != null)
                    {
                        ...
                        {
                            xml_send += "<arg>" + comboBox1.SelectedItem.ToString() + "</arg><arg>50</arg></Request></Requests>";
                        }
                        else
                            return;
                    }
                ...
                oldChanges.leds != LedsProperty || oldChanges.power != PowerProperty || oldChanges.frequency != FrequencyProperty)
            {
                ...
                try
                {
                    ...
                    if (ActiveProperty == "1")
                    {
                        ...
                        if (AnchorProperty == "1")
                        {
                            ...
                            if (oldChanges.Y != textBoxControlY.Text)
                            {
                                ...
                                if ((Convert.ToInt32(textBoxControlX.Text)) < (Convert.ToInt32(textBoxYmin.Text)) || (Convert.ToInt32(textBoxControlX.Text)) > (Convert.ToInt32(textBoxYmax.Text)))
                                {
                            ...
                            if (oldChanges.locrate != textBoxLocRate.Text)
                            {
                                ...
                                if (((Convert.ToInt32(textBoxLocRate.Text)) < (Convert.ToInt32(textBoxLocRateMin.Text))) || ((Convert.ToInt32(textBoxLocRate.Text)) > (Convert.ToInt32(textBoxLocRateMax.Text))))
                                {
                    ...
                    if (oldChanges.samplerate != textBoxSampleRate.Text)
                    {
                        ...
                        //if ((Convert.ToInt32(textBoxSampleRate.Text)) < (Convert.ToInt32(textBoxSensorRateMin.Text)) || (Convert.ToInt32(textBoxSampleRate)) > (Convert.ToInt32(textBoxSensorRateMax.Text)))
                        //{
                        //    MessageBox.Show("SampleRate is not within bounds");
                        //    textBoxControlX.Text = oldChanges.samplerate;
                        //    return;
                        //}
                        //int rate = Convert.ToInt32(textBoxSampleRate.Text);
                    }
        ...
        private void SensorsTimeOut()
        {
            ...
            string xml_send = @"<?xml version=""1.0"" standalone=""yes""?><Requests xmlns:xsi=""='http://www.w3.org/2001/XMLSchema-instance'""  xmlns=""xmlns='http://tempuri.org/Requests.xsd\'""><Request><RequestName>getTimeOutSensors</RequestName><arg>5 00:00:00</arg></Request></Requests>";
            try
            {
                SocketClient socket_client = new SocketClient(Port, controllerIP.Text);
                // Receiving data
        ...
        private void maskedTextBox1_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
            ...
            toolTipActive.Show("Enter the timeout parameter as days hours:minutes:seconds (d hh:mm:ss)", maskedTextBox1, maskedTextBox1.Location, 5000);
        }
